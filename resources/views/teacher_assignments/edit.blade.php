...
@section('title', 'Sửa phân công giáo viên')
            ...
            <form action="{{ route('teacher_assignments.update', $teacherAssignment) }}" method="POST">
                    ...
                    <select name="teacher_id" 
                        ...
                        @foreach($teachers as $teacher)
                            <option value="{{ $teacher->id }}" 
                                    {{ old('teacher_id', $teacherAssignment->teacher_id) == $teacher->id ? 'selected' : '' }}>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="note" 
                              ...
                              maxlength="255"
                              class="w-full px-4 py-2.5 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                              placeholder="Nhập ghi chú (không bắt buộc)">{{ old('note', $teacherAssignment->note) }}</textarea>
